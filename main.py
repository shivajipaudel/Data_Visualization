...
root = Tk()
root.title("Data Visualizer using Python : Shivaji Paudel")
...
h_name = Label(root, text="Data Visualizer using Python", fg="deep sky blue", font=('roman', 24, 'bold')).place(relx=0.22, rely=0.01)
m_name = Label(root, text="Shivaji Paudel", fg="blue2", font=('times', 21, 'underline')).place(relx=0.40, rely=0.07)
